<?php
    ...
    class admin_model extends CI_Model{
        ...
        {
            return  $this->db->query("SELECT el_siswa.id,el_siswa.nama,nis,agama, jenis_kelamin,el_kelas.nama as kelas, status_id FROM el_siswa left join el_kelas_siswa on el_kelas_siswa.siswa_id=el_siswa.id left join el_kelas ON el_kelas.id=el_kelas_siswa.kelas_id WHERE status_id=".$status." GROUP BY NIS");
        }
