                ...
                <div class="mx-auto d-block">
                    <div class="container-fluid">
                      <div class="card card-body">
                        <div style="border: 1px solid black;background-color: #5a6268;color: white;font-weight: bold; font-color:white;" class="text-white"><span class="text-white">Waktu Anda mengerjakan Ujian </span><span id="hours" class="text-white"></span>:<span id="minutes" class="text-white"></span>:<span id="seconds" class="text-white"    ></span></div>
