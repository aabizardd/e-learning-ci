                    ...
                    <div class="container-fluid"> 
                        ...
                        <div class="row">
                            <div class="col-lg">
                                ...
                                <span class="span7">Profile Siswa</span><span style="margin-bottom: 10px" class="span5 pull-right"><a href="#modalSiswa" class="btn btn-secondary btn-sm" type="button" data-toggle="modal">Edit Profile</a> <a href="#modalFoto" class="btn btn-secondary btn-sm" type="button" data-toggle="modal">Edit Foto Profile</a></span>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table">
                                        <?php $siswa_id='';foreach ($siswa as $key) {?>
                                        <thead>
                                            <tr>
                                                <th width="20%">NIS</th>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php $kelas_aktif_id='';?>
                                <span class="span7">Kelas Siswa</span><span style="margin-bottom: 10px" class="span5 pull-right"><a href="#modalKelas" class="btn btn-secondary btn-sm" type="button" data-toggle="modal">Edit Kelas</a></span>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table">
                                        <thead>
                                            <tr>
                            ...
                            <div class="col-md-6">
                                <span class="span7">Akun Siswa</span><span style="margin-bottom: 10px" class="span5 pull-right"><a href="#modalAkun" class="btn btn-secondary btn-sm" type="button" data-toggle="modal">Edit Akun</a></span>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table">
                                        <?php $akun_id='';$akun_username='';$akun_password='';foreach ($akun as $key) { $akun_username=$key->username;$akun_password=$key->password;$akun_id=$key->id;?>
                                        <thead>
                                            <tr>
                ...
                <?php foreach ($siswa as $key) {?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="agama" class="form-control" required>
                                        <option value="ISLAM" <?php if ($key->jenis_kelamin == 'ISLAM'){ echo "selected"; } ?>>ISLAM</option>
                                        <option value="KRISTEN" <?php if ($key->jenis_kelamin == 'KRISTEN'){ echo "selected"; } ?>>KRISTEN</option>
                                        <option value="KATOLIK" <?php if ($key->jenis_kelamin == 'KATOLIK'){ echo "selected"; } ?>>KATOLIK</option>
                                        <option value="HINDU" <?php if ($key->jenis_kelamin == 'HINDU'){ echo "selected"; } ?>>HINDU</option>
                                        <option value="BUDHA" <?php if ($key->jenis_kelamin == 'BUDHA'){ echo "selected"; } ?>>BUDHA</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label >Alamat</label>
                    ...
                    <button type="button" data-dismiss="modal" class="btn btn-secondary mb-2">Cancel</button>
                </form>
            </div>
            </div>
          </div>
        ...
        <div class="modal fade" id="modalFoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="<?=base_url()?>Admin/updateFotoSiswa/<?=$siswa_id?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                <?php foreach ($siswa as $key) {?>
                                <div class="form-group">
                                    <label >Foto</label>
