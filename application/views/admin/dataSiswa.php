            			...
            			<div class="map-data m-b-40">
            				<div class="row">
            					<div class="col-lg">
            						...
            						<a href="<?=base_url()?>Admin/tambahSiswa" class="btn btn-secondary">Tambah
            							Siswa</a>
            						<div class="btn-group btn-group-sm pull-right" role="group"
            							aria-label="Basic example" style="margin-bottom: 10px">
            									...
            									<tr>
            										...
            										<td>
            											<a type="button" class="btn btn-secondary btn-sm"
            												href="<?=base_url()?>Admin/detailSiswa/<?=$key->id;?>">Detail</a>

            											<?php if ($key->status_id==1) { ?>
            											<a type="button" class="btn btn-danger btn-sm"
            												href="<?=base_url()?>Admin/updateStatusSiswa/<?=$key->id;?>/2">Blok</a>
            											<a type="button" class="btn btn-success btn-sm"
            												href="<?=base_url()?>Admin/updateStatusSiswa/<?=$key->id;?>/3">Alumni</a>
            											<a type="button" class="btn btn-warning btn-sm"
            												href="<?=base_url()?>Admin/updateStatusSiswa/<?=$key->id;?>/4">Hapus</a>
            											<?php } ?>
            											<?php if ($key->status_id==0) { ?>
            											<a type="button" class="btn btn-success btn-sm"
            												href="<?=base_url()?>Admin/updateStatusSiswa/<?=$key->id;?>/1">Aktif</a>
            											<a type="button" class="btn btn-danger btn-sm"
            												href="<?=base_url()?>Admin/updateStatusSiswa/<?=$key->id;?>/2">Blok</a>
            											<?php }?>
