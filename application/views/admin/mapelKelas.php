                ...
                <div class="mx-auto d-block">
                    <div class="container-fluid">
                      ...
                      <div class="card card-body">
                        <h5><?=$key->nama?></h5>
                        <hr>
                            <a href="<?=base_url()?>admin/aturMapelKelas/<?=$key->id?>" class="btn btn-primary pull-right">Tambah</a>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>admin/hapusMapelKelas/<?=$k->id?>" class="btn btn-danger">Hapus</a></td>
                                    </tr>
                                    <?php } }?>
                                    </tbody>
                                </table>
