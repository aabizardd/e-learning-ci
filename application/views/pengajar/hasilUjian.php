                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            ...
                            <ul>
                                ...
                                <li>Total Nilai Essay Maksimal 100</li>
                                <li>Bobot nilai 70% PG dan 30% Essay</li>
                            </ul>
                            </p>
    ...
    ?>
        ...
        if ($key->id == $k->id_siswa) {
            echo $key->nama;
                                            ...
                                            <td><?=$k->jawaban?></td>
                                            <td>
                                                <a href="<?=base_url('assets/images/jawaban_file/' . $k->jawaban_file)?>"
                                                    target="_blank">Lihat
                                                    Jawaban</a>
                                            </td>
                                            <td><?=$k->nilai_pg?></td>
...
if ($k->nilai_essay == '') {
        ?>
                                                <form
                                                    action="<?=base_url()?>pengajar/nilaiEssay/<?=$k->id_jawaban?>/<?=$id_ujian?>"
                                                    method="post">
                                                    <input type="number" name="nilai_essay" placeholder="total point"
